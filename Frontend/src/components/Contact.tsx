                ...
                <div className="flex flex-col md:flex-row w-[90%] justify-between">
                    ...
                    <div className="md:w-1/2">
                        ...
                        <div className="flex justify-around mt-8">
                            ...
                            <div className="w-8 h-8">
                                <svg viewBox="0 0 41.754 33.932" xmlns="http://www.w3.org/2000/svg" className="w-full h-full fill-current text-yellow-400">
                            ...
                            <div className="w-8 h-8">
                                <svg viewBox="0 0 39.398 37.649" xmlns="http://www.w3.org/2000/svg" className="w-full h-full fill-current text-yellow-400">
