                    ...
                    <div className="md:w-1/2">
                        ...
                        <div className="flex justify-around mt-16">
                            ...
                            <div className="w-8 h-8">
                                <svg viewBox="0 0 37.701 37.7" xmlns="http://www.w3.org/2000/svg" className="w-full h-full fill-current text-black">
                            ...
                            <div className="w-8 h-8">
                                <svg viewBox="0 0 41.754 33.932" xmlns="http://www.w3.org/2000/svg" className="w-full h-full fill-current text-black">
                            ...
                            <div className="w-8 h-8">
                                <svg viewBox="0 0 39.398 37.649" xmlns="http://www.w3.org/2000/svg" className="w-full h-full fill-current text-black">
