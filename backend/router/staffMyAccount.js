...
// Route for approving allowance using verified token
router.put('/allowance/:managementId', verifyToken, checkRole(['Manager']), employeePayController.approveAllowance);
